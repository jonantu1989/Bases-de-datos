...
static {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\r\n");
      out.write("\t");
      com.ipartek.formacion.carrito.tipos.Producto productos = null;
      synchronized (request) {
        productos = (com.ipartek.formacion.carrito.tipos.Producto) _jspx_page_context.getAttribute("productos", PageContext.REQUEST_SCOPE);
        if (productos == null){
          productos = new com.ipartek.formacion.carrito.tipos.Producto();
